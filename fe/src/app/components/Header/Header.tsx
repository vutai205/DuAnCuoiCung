...
export default function Header() {
  ...
  return (
    <header className="header">
      ...
      {/* Modal Bảng Giá Vé */}
      <Modal
        title="🎟️ BẢNG GIÁ VÉ NIÊM YẾT - TNA CINEMA"
      ...
      >
        <p style={{ color: "#64748b", marginBottom: 15 }}>
          Áp dụng cho tất cả các phòng chiếu tiêu chuẩn, phòng VIP và IMAX 3D tại hệ thống cụm rạp TNA Cinema.
        </p>
      ...
      <Modal
        title={activeModal === "promotions" ? "🎁 ƯU ĐÃI & KHUYẾN MÃI - TNA CINEMA" : "📰 TIN TỨC ĐIỆN ẢNH - TNA CINEMA"}
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 15 }}>
          <div style={{ border: "1px solid #e2e8f0", padding: 15, borderRadius: 8 }}>
            <Tag color="red">HOT</Tag> <strong>Thứ Ba Vui Vẻ - Đồng giá 50k toàn hệ thống TNA Cinema</strong>
          ...
          <div style={{ border: "1px solid #e2e8f0", padding: 15, borderRadius: 8 }}>
            ...
            <p style={{ margin: "5px 0 0", color: "#475569", fontSize: "0.9rem" }}>
              Nhập mã TNA20K khi thanh toán đơn hàng đặt vé từ 100.000đ qua cổng VNPay Sandbox.
            </p>
          </div>
          <div style={{ border: "1px solid #e2e8f0", padding: 15, borderRadius: 8 }}>
            <Tag color="blue">COMBO</Tag> <strong>Ưu đãi Combo Bỏng Nước Thành Viên TNA Member</strong>
            <p style={{ margin: "5px 0 0", color: "#475569", fontSize: "0.9rem" }}>
      ...
      {/* Modal Giới Thiệu */}
      <Modal
        title="🎬 GIỚI THIỆU HỆ THỐNG RẠP TNA CINEMA"
      ...
      >
        <p style={{ lineHeight: 1.6, color: "#334155" }}>
          <strong>TNA CINEMA</strong> là hệ thống cụm rạp chiếu phim hiện đại đạt chuẩn quốc tế hàng đầu, mang tới cho khán giả trải nghiệm điện ảnh chân thực và sống động vượt trội.
        </p>
